...
<h1> Welcome Doctor: Please complete your Profile</h1>
</div>
<div id="content" class="grid_9">


  <form action="docterRegistration2.jsp">
...
<div align="center">
  <table width="369" border="0">
	...
	<tr>
      ...
      <td width="197"><textarea rows="3" cols="20" name="des"></textarea></td>
      </tr>
    <tr>
    ...
    <tr>
      ...
      <td><textarea rows="3" cols="20" name="com"></textarea></td>
      </tr>

	  <tr>
      <th width="162" scope="row"><div align="left">Affiliations</div></th>
      <td width="197"><textarea rows="3" cols="20" name="aff"></textarea></td>
      </tr>
...
<p align="center">&nbsp;</p>
  <div align="center">
    <table width="383" border="0">
      <tr>
        <th width="158" scope="row"><input type="submit" value="submit" /></th>
