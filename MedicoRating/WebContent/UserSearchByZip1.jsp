...
<h1> Docters List by Zipcode  : <%=request.getParameter("con1") %></h1>
</div>
...
String country=request.getParameter("con1");
  ...
  System.out.println("bfre");
	ps=cn.prepareStatement("select register.email,register.fname,register.photo,register.mobile,register.address1,register.city,register.zipcode,docter.specialities from register INNER JOIN docter ON register.email=docter.email  where  register.user=?  and register.zipcode=?");
