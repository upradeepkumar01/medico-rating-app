...
<div id="content" class="grid_9">
 <%@ include file="index1.jsp"%> <!-- to connect a search box-->
 <br></br>
	...
	<table >
		...
		%>
			...
			<td>
				...
				<a href="new.jsp?m=<%=rs.getString("mobile") %>" target="_blank"><img src="Example/image-folder/<%=rs.getString("photo") %>" width=50 height=50></img></a>
			</td>
		</tr>
		<% }%>
	</table>
