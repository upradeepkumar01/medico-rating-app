...
<![endif]-->  <script type = "text/javascript" >
    history.pushState(null, null, 'hh.jsp');
...
if(rs.next())
{
out.println("Email id already Registered,Please enter another one.");
}
else{
  ...
  out.println("We have sent you a mail.\nplease check your mail for further steps of registration process");
}
